...
class OrcamentoView(ft.Container):
    ...
    def mostrar_aba_historico(self, e):
        ...
        self.lista_component.carregar_historico_db()
        self.pg.update()
    ...
    def exibir_popup_sucesso(self, orcamento_id, nome_cliente):
        ...
        dialogo_sucesso = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.Button("Enviar WhatsApp", on_click=abrir_whatsapp_agora, bgcolor=ft.Colors.GREEN_600, color=ft.Colors.WHITE, icon=ft.Icons.CHAT),
            ],
